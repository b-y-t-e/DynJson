...
{
    public static class JsonToCsDeserializer
    {
        public static Object Deserialize(String Json)
        {
            Char? firstChar = Json.FirstOrDefault(ch => !char.IsWhiteSpace(ch));
            if (firstChar == '{')
                return JsonConvert.DeserializeObject<IDictionary<string, object>>(Json, new DictionaryConverter());
            else if (firstChar == '[')
                return JsonConvert.DeserializeObject<IList<object>>(Json, new DictionaryConverter());
            else
    ...
    public class DictionaryConverter : JsonConverter
    {
        ...
        public override bool CanConvert(Type objectType)
        {
            return
                ...
                typeof(IList<object>).IsAssignableFrom(objectType);
        }
