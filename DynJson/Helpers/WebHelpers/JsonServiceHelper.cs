    ...
    /*public static class JsonServiceHelper
    {
           ...
           Byte[] Content)
        {
            if (!String.IsNullOrEmpty(FileName) && Content != null)
            {
                ...
                String h = "attachment; filename*=UTF-8''" + HttpUtility.UrlPathEncode(FileName).Replace("+", " ") + "";
                WebOperationContext.Current.OutgoingResponse.Headers.Add("Content-Disposition", h);
